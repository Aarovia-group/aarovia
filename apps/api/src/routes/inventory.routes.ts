...
import { getInventory, getInventoryById, createInventory, updateInventory, updateInventoryStatus, getInventoryHeatmap, deleteInventory } from '../controllers/inventory.controller'
